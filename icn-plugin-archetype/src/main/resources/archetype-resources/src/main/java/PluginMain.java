...
public class PluginMain extends Plugin {
	...
	public String getCopyright() {
		return "(C) Insert Copyright Message";
	}
	...
	public String getConfigurationDijitClass() {
		return "${pluginId}Dojo.ConfigurationPane";
	}
	...
	public PluginAction[] getActions() {
		if (pluginActions.length == 0) {
			pluginActions = new PluginAction[] {
					new ${package}.actions.SampleAction()
			};
		}
	...
	public PluginService[] getServices() {
		if (pluginServices.length == 0) {
			pluginServices = new PluginService[] {new ${package}.services.SampleService() };
		}
